...
import com.example.doancoso3.adapter.MeoAdapter;
...
public class MeoActivity extends AppCompatActivity {
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                adapterMeo = new MeoAdapter(getApplicationContext(), sanPhamMoiList);
                                recyclerView.setAdapter(adapterMeo);
                            }
    ...
    private void AnhXa() {
        ...
        recyclerView = findViewById(R.id.recycleview_meo);
