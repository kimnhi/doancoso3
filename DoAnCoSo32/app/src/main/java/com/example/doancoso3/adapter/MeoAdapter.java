...
public class MeoAdapter extends RecyclerView.Adapter<MeoAdapter.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public MeoAdapter(Context context, List<SanPhamMoi> array) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itemmeo_ten);
            giasp = itemView.findViewById(R.id.itemmeo_gia);
            mota = itemView.findViewById(R.id.itemmeo_mota);
            hinhanh = itemView.findViewById(R.id.itemmeo_image);
